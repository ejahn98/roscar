...
(cl:defmethod cl:initialize-instance :after ((m <MsgTutorial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MsgTutorial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Smart_Car-msg:<MsgTutorial> is deprecated: use Smart_Car-msg:MsgTutorial instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MsgTutorial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Smart_Car-msg:data-val is deprecated.  Use Smart_Car-msg:data instead.")
  (data m))
