...
message(STATUS "Smart_Car: 1 messages, 0 services")

set(MSG_I_FLAGS "-ISmart_Car:/home/ubunturlgns/catkin_ws/src/Smart_Car/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubunturlgns/catkin_ws/src/Smart_Car/msg/where.msg" NAME_WE)
add_custom_target(_Smart_Car_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "Smart_Car" "/home/ubunturlgns/catkin_ws/src/Smart_Car/msg/where.msg" ""
)
...
_generate_msg_cpp(Smart_Car
  "/home/ubunturlgns/catkin_ws/src/Smart_Car/msg/where.msg"
  "${MSG_I_FLAGS}"
  ""
